...
const projectData = {
    ...
    project3: {
        ...
        googleColabLink: "https://colab.research.google.com/drive/1gkR-XsuJFTGfI-Adfc0i7zynvuZXkRGU?usp=sharing", // Google Colab project URL
        isGoogleColabProject: true // Indicates this project includes a Google Colab link
    },
};
...
function openModal(projectId) {
    ...
    if (project) {
        if (project.p5Sketch) {
            ...
            `;
        } else if (project.isGoogleColabProject) {
            projectDetailContent.innerHTML = `
                <h2>Try Calify <a href="${project.googleColabLink}" target="_blank">here</a></h2>
            `;
        } else {
            projectDetailContent.innerHTML = `
